...
<section class="invest-dubai-section" id="invest-section">
    <div class="invest-container">
        ...
        <div class="invest-content">
            ...
            <h2 class="invest-title invest-anim delay-1">Properties for Sale</h2>
            <div class="invest-text">
                ...
                <ul class="selling-strategy">
                    ...
                    <li>Luxury photography & cinematic videography</li>
                    <li>Targeted digital marketing campaigns</li>
                    <li>Exposure to international investor networks</li>
                    <li>Direct access to qualified buyers</li>
    ...
    <div class="invest-container">
        ...
        <div class="invest-content">
            ...
            <div class="invest-text">
                ...
                <ul class="selling-strategy">
                    <li>High buyer demand for luxury and branded residences</li>
                    <li>Competitive price growth in prime areas</li>
