...
<section class="rent-hero">
    <video autoplay muted loop playsinline class="rent-bg-video">
        <source src="video/Dubai_Real_Estate_Video_Generated.mp4" type="video/mp4">
    </video>
    <div class="rent-overlay"></div>
    
    <div class="rent-hero-content reveal">
        <h1>Properties for Rent</h1>
        <div class="gold-divider"></div>
        <p class="hero-sub">Experience Dubai's Finest Living</p>
    </div>
</section>
...
<section class="info dark reveal">
    <div class="info-content">
        <h2>Residents benefit from:</h2>
        <ul>
            <li>Reliable, high-quality infrastructure</li>
            <li>Communities that feel safe and planned with care</li>
            <li>Plenty of monthly rent apartments in Dubai</li>
            <li>Rental rules that remain expat-friendly</li>
            <li>Straightforward digital systems for online rental</li>
        </ul>
        <p>
            For people new to the city, as well as long-term expats, Dubai ranks as one of the stronger places to rent in the Middle East in 2026. It offers comfort, security, and steady opportunity.
        </p>
    </div>
</section>
    ...
    <div class="faq-container">
        <div class="faq-item">
            <div class="faq-question">
                <h3>Is it a good time to rent in 2026?</h3>
                <span class="faq-icon">+</span>
            </div>
            <div class="faq-answer">
                <p>Yes, rental yields are high and the market offers diverse options from luxury villas to modern apartments.</p>
            </div>
        </div>
        <div class="faq-item">
            <div class="faq-question">
                <h3>Can I rent property as an expat?</h3>
                <span class="faq-icon">+</span>
            </div>
            <div class="faq-answer">
                <p>Absolutely. Dubai has very expat-friendly rental laws allowing you to rent with a valid residency visa.</p>
            </div>
        </div>
        <div class="faq-item">
            <div class="faq-question">
                <h3>What are the hidden costs?</h3>
                <span class="faq-icon">+</span>
            </div>
            <div class="faq-answer">
                <p>Consider 5% agency fees, 5% Ejari deposit, and DEWA (utilities) setup fees when budgeting.</p>
            </div>
        </div>
    </div>
</section>
...
<section class="testimonials dark reveal">
    ...
    <div class="testimonial-row">
        <div class="testimonial">
            <h4>Michael Ross</h4>
            <p>"Found my dream penthouse in record time. The team is impeccable."</p>
        </div>
        <div class="testimonial">
            <h4>Sarah Jenkins</h4>
            <p>"Professional, transparent, and swift. Highly recommended."</p>
        </div>
        <div class="testimonial">
            <h4>David Lee</h4>
            <p>"A truly white-glove service from start to finish."</p>
        </div>
    </div>
</section>
